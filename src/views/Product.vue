          ...
          <div class="col-lg-12">
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="product-thumbs justify-content-center">
                  <carousel
                  ...
                  >
                    ...
                    >
                      <img class="mrpic" src="img/mickey2.jpg" alt="" />
                    </div>
                    ...
                    >
                      <img class="mrpic" src="img/mickey3.jpg" alt="" />
                    </div>
                    ...
                    >
                      <img class="mrpic" src="img/mickey4.jpg" alt="" />
                    </div>
                  </carousel>
                </div>
              </div>
...
export default {
  ...
  methods: {
    changeImage(uriImage) {
      this.gambar_default = uriImage;
    },
  },
};
</script>
